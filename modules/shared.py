...
parser.add_argument("--share", action='store_true', help="use share=True for gradio and make the UI accessible through their site (bugs, use --ngrok instead)")
...
parser.add_argument("--classic", action='store_true', help="Use full original UI",  default=False)
